...
document.addEventListener('DOMContentLoaded', function() {
     ...
     */
    function handleDropboxToggle() {
        // Если пользователь пытается включить, но Dropbox не настроен
        if (uploadToDropboxCheckbox.checked && !dropboxClient.isConfigured()) {
            uploadToDropboxCheckbox.checked = false;
            setStatus('⚠️ Dropbox не настроен. Проверьте config.js', 'error');
        }
    }
